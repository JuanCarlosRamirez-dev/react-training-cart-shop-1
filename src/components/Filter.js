...
import { filterProductsByBasics, sortProducts } from '../actions/productActions'
            ...
            this.props.filteredItems ? (<div>Loading...</div>) :
                <div className="filter">
                    ...
                    <label htmlFor="checkbox1">Basics</label> */}
                        ...
                        <select value={this.props.basics} onChange={(e) => this.props.filterProductsByBasics(this.props.products, e.target.value)} >
